...
export const getStatusColor = (status) => {
  switch (status) {
    case TASK_STATUS.TODO: return 'bg-slate-200 text-slate-800 dark:bg-slate-700 dark:text-slate-300';
...
export const getPriorityColor = (priority) => {
  switch (priority) {
    ...
    case TASK_PRIORITY.URGENT: return 'bg-danger/20 text-danger dark:bg-danger/10';
    default: return 'bg-slate-100 text-slate-800';
  }
};
