  ...
  return (
    ...
    >
      ...
      <div className={`max-w-[70%] flex flex-col ${isOwn ? 'items-end' : 'items-start'}`}>
        ...
        <div className={`px-4 py-2 rounded-2xl ${isOwn ? 'bg-indigo-600 text-white rounded-tr-sm' : 'bg-white/10 text-gray-100 rounded-tl-sm border border-white/5 backdrop-blur-md'}`}>
