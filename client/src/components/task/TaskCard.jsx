...
const TaskCard = ({ task, onClick, isDragging: isDraggingProp }) => {
 ...
 className={`bg-neutral-800 border border-neutral-200 dark:border-neutral-800 p-4 rounded-xl cursor-grab active:cursor-grabbing hover:bg-neutral-800/80 hover:border-neutral-200 dark:border-neutral-800 transition-all hover:shadow-lg ${
 dragging
 ...
 <h4 className='text-sm font-medium text-black dark:text-white mb-2 leading-snug'>
 {task.title}
 </h4>
