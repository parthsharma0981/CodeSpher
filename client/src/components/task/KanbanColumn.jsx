...
const KanbanColumn = ({ column, tasks, onTaskClick }) => {
 ...
 <span className='bg-white/10 text-neutral-300 text-xs px-2 py-0.5 rounded-full'>
 {tasks.length}
 </span>
 </div>
 <button className='text-neutral-400 hover:text-black dark:text-white p-1 hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded'>
