...
const ActivityFeed = ({ activities }) => {
  return (
    <div className="relative pl-6 border-l border-slate-700/50 space-y-6">
      {activities.map((activity, index) => (
        <motion.div
          ...
          className="relative"
        >
          <div className={`absolute -left-[30px] w-3 h-3 rounded-full ${activityColors[activity.type]} ring-4 ring-slate-900`} />
