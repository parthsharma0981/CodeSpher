...
const Avatar = ({ src, name, size = 'md', isOnline = false, className = '' }) => {
 ...
 "rounded-full flex items-center justify-center bg-gradient-to-br from-black to-neutral-700 text-black dark:text-white font-medium ring-2 ring-white dark:ring-neutral-900 overflow-hidden",
 sizes[size],
 className
 )}
 >
