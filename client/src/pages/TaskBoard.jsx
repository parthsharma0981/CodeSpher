...
const TaskBoard = () => {
 ...
 <div>
 <h1 className="text-2xl font-bold text-black dark:text-white mb-1">Task Board</h1>
 ...
 className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg pl-9 pr-3 py-1.5 text-sm text-black dark:text-white placeholder-neutral-500 focus:outline-none focus:border-indigo-500 w-48"
 />
 {searchQuery && (
 <button onClick={() => setSearchQuery('')} className="absolute right-2 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-black dark:text-white">
 <X className="w-3 h-3" />
 </button>
 )}
 </div>
 ...
 className={`w-full text-left px-3 py-2 rounded-lg text-sm capitalize transition-colors ${filterPriority === p ? 'bg-indigo-600/20 text-neutral-600 dark:text-neutral-400' : 'text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-800'}`}
 >
