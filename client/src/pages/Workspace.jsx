...
const Workspace = () => {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto min-h-screen">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center text-xl font-bold text-white shadow-lg">
      ...
      {/* Navigation */}
      <div className="flex space-x-1 mb-8 bg-white/5 p-1 rounded-2xl border border-white/10 max-w-fit">
        {tabs.map((tab) => {
          const Icon = tab.icon;
