...
const stats = [
 ...
 { title: 'Tasks Due Today', value: '5', icon: Clock },
 { title: 'Completed Tasks', value: '148', icon: CheckCircle2 },
...
const Dashboard = () => {
 ...
 {/* Header */}
 <div className="mb-8">
 <h1 className="text-3xl font-bold text-black dark:text-white mb-2">Welcome back, Developer! 👋</h1>
 ...
 <button className="text-sm text-neutral-500 hover:text-black dark:hover:text-black dark:text-white transition-colors">View All</button>
 </div>
 ...
 <h2 className="text-xl font-bold text-black dark:text-white mb-6">Weekly Productivity</h2>
 ...
 <section className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6">
 <div className="flex items-center justify-between mb-6">
 <h2 className="text-lg font-bold text-black dark:text-white">Tasks Due Today</h2>
 </div>
 ...
 {/* Team Online */}
 <section className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6">
 <h2 className="text-lg font-bold text-black dark:text-white mb-4">Team Online</h2>
 <div className="flex gap-2 flex-wrap">
 {teamOnline.map((member, i) => (
 <div key={i} className="relative">
 <img src={member.avatar} alt={member.name} className="w-10 h-10 rounded-full border-2 border-white dark:border-neutral-900" />
 <span className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white dark:border-neutral-900 ${
 member.status === 'online' ? 'bg-neutral-900 dark:bg-white' :
 member.status === 'away' ? 'bg-neutral-400' : 'bg-neutral-300 dark:bg-neutral-600'
 }`} />
 </div>
 ))}
 </div>
