...
const INITIAL_NOTIFICATIONS = [
 ...
 { id: 5, type: 'member_joined', title: 'New Team Member', description: 'Alex joined your workspace "Frontend Devs"', time: 'Yesterday', read: true, icon: UserPlus, color: 'text-neutral-500', bg: 'bg-cyan-400/10' },
...
const Notifications = () => {
 ...
 return (
 <div className="p-6 md:p-8 max-w-4xl mx-auto min-h-screen text-black dark:text-white">
 {/* Header */}
 ...
 className="bg-[#1E293B] border border-neutral-200 dark:border-neutral-800 rounded-lg px-4 py-2 text-sm text-black dark:text-white focus:outline-none focus:border-indigo-500"
 >
 ...
 className="text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-500 font-medium transition-colors"
 >
 Mark all as read
 </button>
 </div>
 ...
 <h4 className={`text-base font-medium ${notif.read ? 'text-neutral-300' : 'text-black dark:text-white'}`}>
 {notif.title}
 </h4>
 ...
 className="text-gray-500 hover:text-rose-400 transition-colors p-1 rounded-md hover:bg-neutral-50 dark:hover:bg-neutral-800"
 title="Dismiss"
 >
 <Trash2 size={16} />
 </button>
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-indigo-600 hover:bg-indigo-500 text-black dark:text-white rounded-lg transition-colors"
 >
