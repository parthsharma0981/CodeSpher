...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark overflow-hidden selection:bg-primary/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#pricing" className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-white transition-colors">Pricing</a>
              <a href="#about" className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-white transition-colors">About</a>
            </div>
            <div className="flex items-center gap-4">
              <Link to={ROUTES.LOGIN} className="text-sm font-medium text-slate-700 dark:text-slate-200 hover:text-primary dark:hover:text-white transition-colors hidden sm:block">
                Log in
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <Button size="lg" variant="secondary" className="w-full sm:w-auto bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm">
          ...
          >
            <div className="glass-card p-2 rounded-2xl md:p-4 bg-white/40 dark:bg-slate-900/40">
              <img 
            ...
            >
              <div className="flex -space-x-2">
                {[1,2,3].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full bg-slate-300 dark:bg-slate-700 border-2 border-white dark:border-slate-800 flex items-center justify-center text-xs font-bold">
                    U{i}
                  </div>
                ))}
              </div>
              <div>
                ...
                <p className="text-xs text-slate-500">Collaborating now</p>
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* Stats Section */}
      <section className="py-10 border-y border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                <div className="w-10 h-10 mb-3 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center text-primary">
      ...
      <section id="features" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-2 text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="glass-card p-8 flex flex-col">
              ...
              <div className="text-4xl font-extrabold dark:text-white mb-6">$0<span className="text-base font-medium text-slate-500">/mo</span></div>
            ...
            {/* Pro Plan */}
            <div className="glass-card p-8 flex flex-col relative transform md:-translate-y-4 border-primary/50 shadow-primary/20">
              ...
              <div className="text-4xl font-extrabold dark:text-white mb-6">$12<span className="text-base font-medium text-slate-500">/mo</span></div>
              <ul className="space-y-4 mb-8 flex-1">
