...
const Profile = () => {
 return (
 <div className="min-h-screen text-black dark:text-white pb-12">
 {/* Cover Banner */}
 ...
 <p className="text-neutral-600 dark:text-neutral-400 font-medium text-lg">Senior Frontend Engineer</p>
 ...
 whileTap={{ scale: 0.95 }}
 className="mt-6 sm:mt-0 px-6 py-2.5 bg-white/10 hover:bg-white/20 border border-neutral-200 dark:border-neutral-800 rounded-xl font-medium flex items-center transition-colors backdrop-blur-md"
 >
 ...
 key={i}
 className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 text-center hover:bg-white/[0.07] transition-colors"
 >
 <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-neutral-500">{stat.value}</div>
 ...
 <span key={skill} className="px-3 py-1 bg-indigo-500/20 text-neutral-500 border border-indigo-500/30 rounded-lg text-sm font-medium">
 {skill}
 </span>
 ))}
 </div>
 ...
 <a href="#" className="flex items-center text-gray-300 hover:text-neutral-600 dark:text-neutral-400 transition-colors">
 ...
 <div className="flex items-center justify-center w-10 h-10 rounded-full border border-neutral-200 dark:border-neutral-800 bg-neutral-900 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 text-neutral-600 dark:text-neutral-400">
 {act.type === 'code' ? <Github size={16}/> : act.type === 'task' ? <CheckCircle size={16}/> : <MessageCircle size={16}/>}
 </div>
 <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-4 rounded-xl shadow backdrop-blur-sm group-hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors">
 <div className="flex items-center justify-between mb-1">
 <span className="font-semibold text-black dark:text-white">{act.text}</span>
 </div>
