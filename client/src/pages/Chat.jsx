...
const Chat = () => {
 ...
 return (
 <div className="flex h-full min-h-[calc(100vh-4rem)] bg-neutral-900 overflow-hidden text-black dark:text-white rounded-2xl border border-neutral-200 dark:border-neutral-800 m-4">
 {/* Sidebar */}
 <div className="w-72 flex flex-col border-r border-neutral-200 dark:border-neutral-800 bg-neutral-900/50 ">
 ...
 className="w-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg pl-10 pr-4 py-2 text-sm text-black dark:text-white placeholder-gray-500 focus:outline-none focus:border-indigo-500 transition-colors"
 />
 </div>
 </div>
 ...
 <div className="mb-6">
 <div className="flex items-center justify-between px-2 mb-2 group cursor-pointer text-gray-400 hover:text-black dark:text-white transition-colors">
 ...
 {/* Chat Header */}
 <div className="h-16 px-6 flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 bg-white/5 backdrop-blur-md">
 ...
 <button className="hover:text-black dark:text-white transition-colors"><Bell size={20} /></button>
 <button className="hover:text-black dark:text-white transition-colors"><Users size={20} /></button>
 <button onClick={() => setShowInfo(!showInfo)} className={`transition-colors ${showInfo ? 'text-neutral-600 dark:text-neutral-400' : 'hover:text-black dark:text-white'}`}>
 <Info size={20} />
 </button>
 </div>
 </div>
 ...
 <span className="text-xs font-medium text-gray-500 bg-white/5 px-3 py-1 rounded-full border border-neutral-200 dark:border-neutral-800">Today</span>
 </div>
 ...
 className="border-l border-neutral-200 dark:border-neutral-800 bg-neutral-900/80 flex flex-col"
 >
 <div className="p-6 border-b border-neutral-200 dark:border-neutral-800 text-center">
 {activeChannel ? (
 <>
 <div className="w-16 h-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-4 border border-neutral-200 dark:border-neutral-800">
 <Hash size={32} className="text-neutral-600 dark:text-neutral-400" />
 </div>
